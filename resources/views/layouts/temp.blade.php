...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="{{asset('gambar/logoclha.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
      style="opacity: .8">
      <span class="brand-text font-weight-light">SMK CLHA'49 RCK</span>
    </a>
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                 ...
                 <a href="#" class="nav-link" onclick="alert('Kamu sudah isi formulir, jika ingin mengganti data pilih menu Ganti Formulir')";>
                  @else
                ...
                <li class="nav-item">
                  <a href="{{ url('gantiFormulir') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Ganti Formulir</p>
                  </a>
                </li>
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                  <a href="{{ url('pengumumanSiswa') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Pengumuman</p>
                  </a>
                </li>
